...
@section('title', 'Профиль аккаунта | '. config('app.name'))
@section('page.title', 'Профиль аккаунта')
            ...
            <div class="c-tabs__content tab-content" id="nav-tab-content">
                <form method="post" class="c-tabs__pane {{ $security ?: 'active' }}" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="c-field u-mb-small">
                                ...
                                <input class="c-input" data-toggle="datepicker" type="text" id="birthdate" name="birthdate" value="{{ $collection->birthdate ? $collection->birthdate->format('d.m.Y') : '' }}" placeholder="Дата рождения">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="u-flex u-mt-medium">
                        <button type="submit" class="c-btn c-btn--success">Сохранить изменения</button>
                    </div>
